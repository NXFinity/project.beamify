      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build master_admin
<span># Test</span>
nx test master_admin
<span># Lint</span>
nx lint master_admin
<span># Run them together!</span>
nx run-many -p master_admin -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project master_admin</pre>
          </details>
