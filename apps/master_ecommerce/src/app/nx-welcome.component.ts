      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build master_ecommerce
<span># Test</span>
nx test master_ecommerce
<span># Lint</span>
nx lint master_ecommerce
<span># Run them together!</span>
nx run-many -p master_ecommerce -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project master_ecommerce</pre>
          </details>
